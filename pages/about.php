        ...
        <div class="row">
            ...
            <div class="small-12 large-12 columns">
                <div class="panel-about">
                    ...
                    <div class="body">
                        <p>Institutions use different policies and criteria to determine grades, this website should be used as a guide only. This website is only able to calculate average grades and no responsibility for any descrepencies will be taken by the author.</p>
                    </div>
                </div>
            </div>
